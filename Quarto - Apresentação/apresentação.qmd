...
conf_int <- confint(amostra, level = 0.90)

# Renomeia as colunas do intervalo de confiança
colnames(conf_int) <- c("10%", "90%")

# Mostra o intervalo de confiança com as novas colunas
conf_int
```
...
ggplot(db, aes(x = quant_artigos)) +
  ...
  annotate("segment",
           ...
           color = "blue",
           size = 0.8) +
  geom_point(aes(x = 25.4, y = 11), color = "blue", size = 2) +
  annotate("text",
           x = 70,
           y = 10,
