...
hist(comb_amost_mean, main = "histograma de médias amostrais (n = 10)", xlab = "Médias", ylab = "Frequência")
```
...
<span class="small-text"> A probabilidade de um elemento específico estar na amostra é de `r prob_elem_amostra` </span>
